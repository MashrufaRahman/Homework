...
public interface Phone extends Pager, Wakitaki {
	...
	// We can't create the non abstract method battery and wireless method in the interface.
	// InterfaceInfo cannot implement in the interface class because interface class contains only abstract method.
	}
